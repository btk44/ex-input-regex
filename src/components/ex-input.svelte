...
<style>
    ...
    label { display: block; width: 400; padding: 1px 4px; box-sizing: border-box; font-size: small; margin: 0 4px;}
    input, select, button { display: block; margin: 4px; width: 400px; height: 40px; padding: 1px 4px; box-sizing: border-box;}
    .input-section { position: relative;}
    .tip { width: 400px; height: 300px; position: absolute; top: -300px; left: 4px; overflow-y: auto; overflow-x: hidden; border: 1px red solid; background-color: white; font-size: small; padding: 4px;}
</style>